...
allow ingress traffic only from summary pod in yaobook namespace to database pod in yaobook namespace 
...
kubectl exec -ti $CUSTOMER_POD -n yaobank 
-c customer -- /bin/bash
...
これはkubernetes.io/hostnameってlabelのあるnodeに対して適応している
しかし、kubernetes.io/hostnameは全てのnodeに対して存在しているから実質全てに適応することになる
